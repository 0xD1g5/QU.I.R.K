...
**Success Criteria** (what must be TRUE):
  ...
  3. The drawer displays the finding's score-lift attribution, consuming Phase 201's LIFT-01
     per-remediation-theme number. **Corrected 2026-09-21 (Phase 208 DOC-01):** this criterion
     previously read "consuming Phase 201's LIFT-01 per-item number" — that wording is not honestly
     implementable, since `score_lift` is keyed by remediation theme covering N findings (D-01 /
     D-08 / D-09). This file's own line-187 note already flagged it: "ROADMAP's criterion-3 wording
     is now stale relative to what shipped — flagged for a doc correction."

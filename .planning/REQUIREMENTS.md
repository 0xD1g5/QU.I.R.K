...
- [x] **CBOM-02**: User reviews the algorithm classifier coverage report: every algorithm name observed in test fixtures and chaos labs is mapped to a NIST PQC classification, with no `unknown` fallbacks for in-scope cases.

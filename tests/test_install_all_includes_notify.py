...
@pytest.mark.slow
@pytest.mark.skip(reason="TRIAGE-149: flaky (pip --dry-run subprocess contention under full-suite load, passes standalone); see docs/test-triage-149.md#test_install_all_includes_notifypy-test_install_all_includes_notify")

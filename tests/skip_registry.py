...
ALLOWED_SKIPS = [
    ...
    ("test_compliance_title_join.py",   23, "pre_existing_triage_149", "TRIAGE-149: genuine coverage gap — 3 Phase 95 codesign finding titles (findings_evaluator.py:1026/1045/1080) were never added to COMPLIANCE_MAP or UNMAPPED_TITLES; see docs/test-triage-149.md#compliance-title-join-codesign-gap"),

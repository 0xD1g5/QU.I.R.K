...
## UAT Series 118 — Windows Operator Zip + Frozen Sensor E2E Auth (Phase 118 — v5.6)

**Requirement coverage:** WINBUILD-03, WINBUILD-04

> UAT-118-01 covers the E2E auth job structure (locally verified) and the live CI green result (deferred human-verify).
> UAT-118-02 covers the Windows operator zip artifact (structure verified in 118-01; live CI confirmation is part of UAT-118-01 since the zip step runs in windows-sensor-build).
